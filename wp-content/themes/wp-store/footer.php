		...
		<div class="footer-copyright">
			<div class="copyright-text">
				...
				if(get_theme_mod('wp_store_footer_setting_footer_copyright_text') && get_theme_mod('wp_store_footer_setting_footer_copyright_text')!=""){
					...
					?>
					<?php esc_html_e( 'Copyrights All Reserved by Mysite','wp-store' );?>
					<!--<a title="<?php esc_attr_e( 'Copyrights All Reserved by','wp-store' );?>" href="<?php //echo esc_url( 'https://8degreethemes.com/wordpress-themes/wp-store/', 'wp-store' ); ?>">
						<?php //esc_html_e('Wp Store','wp-store');?>
					</a>-->
					<?php //esc_html_e('by Mysite','wp-store');?>
					<?php
				}
				?>
			</div>					
